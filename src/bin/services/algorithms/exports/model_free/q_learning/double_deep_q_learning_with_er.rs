...
impl DqnErLogger {
    pub fn new(base_dir: &str, params: &crate::config::DeepLearningParams,
    ...
    pub fn log(&mut self, episode: usize, mean_score: f32, mean_duration: std::time::Duration) {
        ...
        println!(
            "DDQL-ER Mean Score: {:.3} / Mean Duration {:.3} (ep {} — {:.2?} elapsed)",
            mean_score,
    ...
    where
        ...
        B: Backend,
    {
        let path = self.base.run_dir().join(format!("dql_er_model_{ep}.mpk"));
